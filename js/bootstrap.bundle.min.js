...
!(function (t, e) {
  ...
  for (
    var r, n, o, a, l, f, h, u, d, p, g, m, _, v, E, y, b, T, C, w, I, D, A, S, O, N, k, L, P, x, j, R, M, H, W, F, U,B,K,V,Q,Y,G,q,z,X,J,Z,$,tt,et,nt,it,rt,ot,st,at,lt, ct, ft, ht, ut, dt, pt, gt = (function (i) {
        var e = "transitionend";
        function t(t) {
          var e = this,
            n = !1;
  ...
  function kt(t) {
    ...
    for (
      var e = Nt(10) ? document.body : null, n = t.offsetParent;
          ...
          fn: function (t) {
            ...
            return (
              ...
              t.arrowElement &&
                ...
                se(t.arrowElement, t.arrowStyles),
              t
            );
          },
    ...
    pe = (function () {
      function o(t, e) {
        ...
        Ht(this, o),
          ...
          Object.keys(Ut({}, o.Defaults.modifiers, i.modifiers)).forEach(
            function (t) {
              ...
              if ((l._clearMenus(), !e)) {
                ...
                if ((ge(t).trigger(i), !i.isDefaultPrevented())) {
                  ...
                  "ontouchstart" in document.documentElement &&
                    ...
                    ge(document.body).children().on("mouseover", null, ge.noop),
                    this._element.focus(),
      ...
      (on = (function () {
        ...
        return (
          ...
          (t._removeBackdrop = function () {
            this._backdrop &&
              (Ve(this._backdrop).remove(), (this._backdrop = null));
          }),
          ...
          (t._resetScrollbar = function () {
            Ve(rn.FIXED_CONTENT).each(function (t, e) {
              ...
              "undefined" != typeof n &&
                Ve(e).css("padding-right", n).removeData("padding-right");
            }),
              Ve(rn.STICKY_CONTENT + ", " + rn.NAVBAR_TOGGLER).each(function (
                t,
                e
              ) {
                var n = Ve(e).data("margin-right");
                "undefined" != typeof n &&
                  Ve(e).css("margin-right", n).removeData("margin-right");
              });
          ...
          (r._jQueryInterface = function (n, i) {
            return this.each(function () {
              ...
              if (
                (t || ((t = new r(this, e)), Ve(this).data(Ye, t)),
                "string" == typeof n)
              ) {
                if ("undefined" == typeof t[n])
                  throw new TypeError('No method named "' + n + '"');
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                ...
                (t || ((t = new i(this, e)), sn(this).data(ln, t)),
                "string" == typeof n)
              ) {
                if ("undefined" == typeof t[n])
                  throw new TypeError('No method named "' + n + '"');
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                ...
                (t || ((t = new i(this, e)), Sn(this).data(Nn, t)),
                "string" == typeof n)
              ) {
                if ("undefined" == typeof t[n])
                  throw new TypeError('No method named "' + n + '"');
        ...
        return (
          ...
          (t._getConfig = function (t) {
            if ("string" != typeof (t = c({}, qn, t)).target) {
              ...
              e || ((e = gt.getUID(Vn)), Kn(t.target).attr("id", e)),
                (t.target = "#" + e);
            }
          ...
          (t._activate = function (e) {
            ...
            var n = Kn(t.join(","));
            n.hasClass(Jn)
              ? (n.closest($n.DROPDOWN).find($n.DROPDOWN_TOGGLE).addClass(Zn),
                n.addClass(Zn))
              : (n.addClass(Zn),
                n
      ...
      (yi = (function () {
        ...
        return (
          ...
          (t._activate = function (t, e, n) {
            var i = this,
              r = (
                "UL" === e.nodeName ? ii(e).find(mi) : ii(e).children(gi)
              )[0],
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              var t = ii(this),
                e = t.data(ri);
              if (
                (e || ((e = new i(this)), t.data(ri, e)), "string" == typeof n)
              ) {
